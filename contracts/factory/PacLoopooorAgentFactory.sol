...
import { IPacLoopooorAgentFactory } from "./../interfaces/factory/IPacLoopooorAgentFactory.sol";
 ...
 */
contract PacLoopooorAgentFactory is Blastable, Ownable2Step, MulticallableERC2771Context, IPacLoopooorAgentFactory {
    ...
    ***************************************/
    ...
    function _createLoopooorAgent(
        ...
        ILoopooorModuleF(payable(strategyAddress)).moduleF_depositBalance(
            mintParams.wrapMint,
            mintParams.otoken,
