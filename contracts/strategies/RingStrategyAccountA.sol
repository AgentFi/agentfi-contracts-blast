...
import "./LmaoStrategyAccount.sol";
import { IUniversalRouter } from "./../interfaces/external/RingProtocol/IUniversalRouter.sol";

/**
 * @title RingProtocolStrategyAccount
 * @author LMAO Labs
 * @notice A TBA used in an LMAO strategy. This TBA helps automate trades in Ring Protocol.
 *
 * Uses the Ring Protocol UniversalRouter to swap ETH for WETH, USDC, USDT, DAI, BOLT, and RGB.
 */
contract RingStrategyAccountA is LmaoStrategyAccount {
    ...
    ***************************************/
    ...
    constructor(
        ...
        address _guardian
    ) LmaoStrategyAccount(entryPoint_, multicallForwarder, erc6551Registry, _guardian) {}
     ...
     */
    function executeRingProtocolStrategyA(uint256 ethAmount) external payable {
        // checks
