...
import { ERC4337Account } from "./../abstract/ERC4337Account.sol";
import { TokenboundExecutor } from "./../abstract/execution/TokenboundExecutor.sol";
import { ERC6551Executor } from "./../abstract/execution/ERC6551Executor.sol";

import { OPAddressAliasHelper } from "./../lib/OPAddressAliasHelper.sol";

import { IAccountGuardian } from "./../interfaces/abstract/execution/IAccountGuardian.sol";
 ...
 */
contract BlastooorStrategyAccountBase is
    ERC721Holder,
    ERC1155Holder,
    Lockable,
    Permissioned,
    ...
    TokenboundExecutor
{
     ...
     *
     * @dev Can be overriden via StrategyOverridable
     */
     ...
     *
     * @dev Can be overriden via StrategyOverridable except for base interfaces.
     *
    ...
    /**
     * @dev called whenever an ERC-721 token is received. Can be overriden via StrategyOverridable. Reverts
    ...
    /**
     * @dev called whenever an ERC-1155 token is received. Can be overriden via StrategyOverridable.
     */
    ...
    /**
     * @dev called whenever a batch of ERC-1155 tokens are received. Can be overriden via StrategyOverridable.
     */
