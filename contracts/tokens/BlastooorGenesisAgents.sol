...
contract BlastooorGenesisAgents is IBlastooorGenesisAgents, ERC721Enumerable, Blastable, Ownable2Step, Multicall {
    ...
    /**
     * @notice Constructs the BlastooorGenesisAgents nft contract.
    ...
    ) Blastable(blast_, gasCollector_, blastPoints_, pointsOperator_) ERC721("Blastooor Genesis", "BLASTOOOR") {
