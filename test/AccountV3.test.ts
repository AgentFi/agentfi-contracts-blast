...
describe("AccountV3", function () {
  ...
  describe("account creation and registration", function () {
    ...
    it("can create account and register", async function () {
      ...
      erc6551Account1 = await ethers.getContractAt("AccountV3", predictedAddress) as AccountV3;
    ...
    it("account with nft on other chain has no owner on this chain", async function () {
      ...
      erc6551Account2 = await ethers.getContractAt("AccountV3", predictedAddress) as AccountV3;
