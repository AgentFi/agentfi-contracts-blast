...
describe("AlgebraCLAgentFactory", function () {
  ...
  describe("setup", function () {
    ...
    it("can deploy ConcentratedLiquidityModuleE", async function () {
      moduleE = await deployContract(deployer, "ConcentratedLiquidityModuleE", [BLAST_ADDRESS, gasCollector.address, BLAST_POINTS_ADDRESS, BLAST_POINTS_OPERATOR_ADDRESS, WETH_ADDRESS]) as ConcentratedLiquidityModuleE;
